...
- [Полная документация функций API](#полная-документация-функций-api)
...
1.  **ID библиотеки:**
    Идентификатор библиотеки `TelegramApiLib` для Google Apps Script: `1y847eOyoPdYBIJ1ni4g7pJxwriX2a_f-4F1BTjImidTEEJ5iNWvZAO_7`.

### Установка вручную (для пользователей библиотеки)
...
## Полная документация функций API
...
<summary><h3>BotManagement.gs - Общие функции для управления ботом</h3></summary>
...
<details>
<summary><h3>ChatManagement.gs - Функции для управления информацией о чатах</h3></summary>
...
<details>
<summary><h3>ChatMemberManagement.gs - Функции для управления членами чата и их правами</h3></summary>
...
<details>
<summary><h3>ChatInviteLinkManagement.gs - Функции для управления пригласительными ссылками</h3></summary>
...
<details>
<summary><h3>MessageManagement.gs - Функции для управления сообщениями</h3></summary>
...
<details>
<summary><h3>SendingMessages.gs - Функции для отправки сообщений и медиафайлов</h3></summary>
...
<details>
<summary><h3>StickerManagement.gs - Функции для управления стикерами</h3></summary>
...
<details>
<summary><h3>Settings.gs - Функции для управления настройками</h3></summary>
...
<details>
<summary><h3>Utils.gs - Вспомогательные функции</h3></summary>
